...
class CommonVars {
    constructor() {
        ...
        const today = new Date('24-April-2007');
...
describe('AssetSwap tests', () => {
    it('Testing consistency between fair price and fair spread...', () => {
        ...
        const bondSchedule = new Schedule().init2(new Date('4-January-2005'), new Date('4-January-2037'), new Period().init2(Frequency.Annual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const bond = new FixedRateBond().frbInit1(settlementDays, vars.faceAmount, bondSchedule, [0.04], new ActualActual(ActualActual.Convention.ISDA), BusinessDayConvention.Following, 100.0, new Date('4-January-2005'));
    ...
    it('Testing implied bond value against asset-swap ' +
        ...
        const fixedBondSchedule1 = new Schedule().init2(new Date('4-January-2005'), new Date('4-January-2037'), new Period().init2(Frequency.Annual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const fixedBond1 = new FixedRateBond().frbInit1(settlementDays, vars.faceAmount, fixedBondSchedule1, [0.04], new ActualActual(ActualActual.Convention.ISDA), BusinessDayConvention.Following, 100.0, new Date('4-January-2005'));
        ...
        const fixedBondSchedule2 = new Schedule().init2(new Date('5-February-2005'), new Date('5-February-2019'), new Period().init2(Frequency.Annual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const fixedBond2 = new FixedRateBond().frbInit1(settlementDays, vars.faceAmount, fixedBondSchedule2, [0.05], new Thirty360(Thirty360.Convention.BondBasis), BusinessDayConvention.Following, 100.0, new Date('5-February-2005'));
        ...
        const floatingBondSchedule1 = new Schedule().init2(new Date('29-September-2003'), new Date('29-September-2013'), new Period().init2(Frequency.Semiannual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const floatingBond1 = new FloatingRateBond().frbInit1(settlementDays, vars.faceAmount, floatingBondSchedule1, vars.iborIndex, new Actual360(), BusinessDayConvention.Following, fixingDays, [1], [0.0056], [], [], inArrears, 100.0, new Date('29-September-2003'));
        floatingBond1.setPricingEngine(bondEngine);
        setCouponPricer(floatingBond1.cashflows(), vars.pricer);
        vars.iborIndex.addFixing(new Date('27-March-2007'), 0.0402);
        ...
        const floatingBondSchedule2 = new Schedule().init2(new Date('24-September-2004'), new Date('24-September-2018'), new Period().init2(Frequency.Semiannual), bondCalendar, BusinessDayConvention.ModifiedFollowing, BusinessDayConvention.ModifiedFollowing, DateGeneration.Rule.Backward, false);
        const floatingBond2 = new FloatingRateBond().frbInit1(settlementDays, vars.faceAmount, floatingBondSchedule2, vars.iborIndex, new Actual360(), BusinessDayConvention.ModifiedFollowing, fixingDays, [1], [0.0025], [], [], inArrears, 100.0, new Date('24-September-2004'));
        floatingBond2.setPricingEngine(bondEngine);
        setCouponPricer(floatingBond2.cashflows(), vars.pricer);
        vars.iborIndex.addFixing(new Date('22-March-2007'), 0.04013);
        ...
        const cmsBondSchedule1 = new Schedule().init2(new Date('22-August-2005'), new Date('22-August-2020'), new Period().init2(Frequency.Annual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const cmsBond1 = new CmsRateBond(settlementDays, vars.faceAmount, cmsBondSchedule1, vars.swapIndex, new Thirty360(), BusinessDayConvention.Following, fixingDays, [1.0], [0.0], [0.055], [0.025], inArrears, 100.0, new Date('22-August-2005'));
        cmsBond1.setPricingEngine(bondEngine);
        setCouponPricer(cmsBond1.cashflows(), vars.cmspricer);
        vars.swapIndex.addFixing(new Date('18-August-2006'), 0.04158);
        ...
        const cmsBondSchedule2 = new Schedule().init2(new Date('06-May-2005'), new Date('06-May-2015'), new Period().init2(Frequency.Annual), bondCalendar, BusinessDayConvention.Unadjusted, BusinessDayConvention.Unadjusted, DateGeneration.Rule.Backward, false);
        const cmsBond2 = new CmsRateBond(settlementDays, vars.faceAmount, cmsBondSchedule2, vars.swapIndex, new Thirty360(), BusinessDayConvention.Following, fixingDays, [0.84], [0.0], [], [], inArrears, 100.0, new Date('06-May-2005'));
        cmsBond2.setPricingEngine(bondEngine);
        setCouponPricer(cmsBond2.cashflows(), vars.cmspricer);
        vars.swapIndex.addFixing(new Date('04-May-2006'), 0.04217);
        ...
        const zeroCpnBond1 = new ZeroCouponBond(settlementDays, bondCalendar, vars.faceAmount, new Date('20-December-2015'), BusinessDayConvention.Following, 100.0, new Date('19-December-1985'));
        ...
        const zeroCpnBond2 = new ZeroCouponBond(settlementDays, bondCalendar, vars.faceAmount, new Date('17-February-2028'), BusinessDayConvention.Following, 100.0, new Date('17-February-1998'));
    ...
    it('Testing implied generic-bond value against asset-swap' +
        ...
        const parAssetSwap = true;
        const inArrears = false;
        const fixedBondStartDate1 = new Date('4-January-2005');
        const fixedBondMaturityDate1 = new Date('4-January-2037');
        ...
        const error1 = Math.abs(fixedBondAssetSwapPrice1 - fixedBondPrice1);
        expect(error1).toBeLessThan(tolerance2);
        const fixedBondStartDate2 = new Date('5-February-2005');
        const fixedBondMaturityDate2 = new Date('5-February-2019');
        ...
        const error2 = Math.abs(fixedBondAssetSwapPrice2 - fixedBondPrice2);
        expect(error2).toBeLessThan(tolerance2);
        const floatingBondStartDate1 = new Date('29-September-2003');
        const floatingBondMaturityDate1 = new Date('29-September-2013');
        ...
        const error3 = Math.abs(floatingBondAssetSwapPrice1 - floatingBondPrice1);
        expect(error3).toBeLessThan(tolerance2);
        const floatingBondStartDate2 = new Date('24-September-2004');
        const floatingBondMaturityDate2 = new Date('24-September-2018');
        ...
        const error5 = Math.abs(floatingBondAssetSwapPrice2 - floatingBondPrice2);
        expect(error5).toBeLessThan(tolerance2);
        const cmsBondStartDate1 = new Date('22-August-2005');
        const cmsBondMaturityDate1 = new Date('22-August-2020');
        ...
        const error6 = Math.abs(cmsBondAssetSwapPrice1 - cmsBondPrice1);
        expect(error6).toBeLessThan(tolerance2);
        const cmsBondStartDate2 = new Date('06-May-2005');
        const cmsBondMaturityDate2 = new Date('06-May-2015');
        ...
        const error7 = Math.abs(cmsBondAssetSwapPrice2 - cmsBondPrice2);
        expect(error7).toBeLessThan(tolerance2);
        const zeroCpnBondStartDate1 = new Date('19-December-1985');
        const zeroCpnBondMaturityDate1 = new Date('20-December-2015');
        ...
        expect(error8).toBeLessThan(tolerance2);
        const zeroCpnBondStartDate2 = new Date('17-February-1998');
        const zeroCpnBondMaturityDate2 = new Date('17-February-2028');
    ...
    it('Testing clean and dirty prices for specialized bond' +
        ...
        const bondEngine = new DiscountingBondEngine(vars.termStructure);
        fixedBond1.setPricingEngine(bondEngine);
        const fixedSpecializedBond1 = new FixedRateBond().frbInit1(settlementDays, vars.faceAmount, fixedBondSchedule1, [0.04], new ActualActual(ActualActual.Convention.ISDA), BusinessDayConvention.Following, 100.0, new Date('4-January-2005'));
        ...
        const fixedBond2 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, fixedBondMaturityDate2, fixedBondStartDate2, fixedBondLeg2);
        fixedBond2.setPricingEngine(bondEngine);
        const fixedSpecializedBond2 = new FixedRateBond().frbInit1(settlementDays, vars.faceAmount, fixedBondSchedule2, [0.05], new Thirty360(Thirty360.Convention.BondBasis), BusinessDayConvention.Following, 100.0, new Date('5-February-2005'));
        ...
        const floatingBond1 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, floatingBondMaturityDate1, floatingBondStartDate1, floatingBondLeg1);
        floatingBond1.setPricingEngine(bondEngine);
        const floatingSpecializedBond1 = new FloatingRateBond().frbInit1(settlementDays, vars.faceAmount, floatingBondSchedule1, vars.iborIndex, new Actual360(), BusinessDayConvention.Following, fixingDays, [1], [0.0056], [], [], inArrears, 100.0, new Date('29-September-2003'));
        ...
        const floatingBond2 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, floatingBondMaturityDate2, floatingBondStartDate2, floatingBondLeg2);
        floatingBond2.setPricingEngine(bondEngine);
        const floatingSpecializedBond2 = new FloatingRateBond().frbInit1(settlementDays, vars.faceAmount, floatingBondSchedule2, vars.iborIndex, new Actual360(), BusinessDayConvention.ModifiedFollowing, fixingDays, [1], [0.0025], [], [], inArrears, 100.0, new Date('24-September-2004'));
        ...
        const cmsBond1 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, cmsBondMaturityDate1, cmsBondStartDate1, cmsBondLeg1);
        cmsBond1.setPricingEngine(bondEngine);
        const cmsSpecializedBond1 = new CmsRateBond(settlementDays, vars.faceAmount, cmsBondSchedule1, vars.swapIndex, new Thirty360(), BusinessDayConvention.Following, fixingDays, [1.0], [0.0], [0.055], [0.025], inArrears, 100.0, new Date('22-August-2005'));
        ...
        const cmsBond2 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, cmsBondMaturityDate2, cmsBondStartDate2, cmsBondLeg2);
        cmsBond2.setPricingEngine(bondEngine);
        const cmsSpecializedBond2 = new CmsRateBond(settlementDays, vars.faceAmount, cmsBondSchedule2, vars.swapIndex, new Thirty360(), BusinessDayConvention.Following, fixingDays, [0.84], [0.0], [], [], inArrears, 100.0, new Date('06-May-2005'));
        ...
        const zeroCpnBond1 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, zeroCpnBondMaturityDate1, zeroCpnBondStartDate1, zeroCpnBondLeg1);
        zeroCpnBond1.setPricingEngine(bondEngine);
        const zeroCpnSpecializedBond1 = new ZeroCouponBond(settlementDays, bondCalendar, vars.faceAmount, new Date('20-December-2015'), BusinessDayConvention.Following, 100.0, new Date('19-December-1985'));
        ...
        const zeroCpnBond2 = new Bond().init2(settlementDays, bondCalendar, vars.faceAmount, zeroCpnBondMaturityDate2, zeroCpnBondStartDate2, zeroCpnBondLeg2);
        zeroCpnBond2.setPricingEngine(bondEngine);
        const zeroCpnSpecializedBond2 = new ZeroCouponBond(settlementDays, bondCalendar, vars.faceAmount, new Date('17-February-2028'), BusinessDayConvention.Following, 100.0, new Date('17-February-1998'));
