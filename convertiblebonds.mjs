...
describe(`Convertible bond tests ${version}`, () => {
    ...
    it('Testing fixed-coupon convertible bond in known regression case...', () => {
        ...
        const today = DateExt.UTC('23,December,2008');
        ...
        dates[0] = DateExt.UTC('29,December,2008');
        forwards[0] = 0.0025999342800;
        dates[1] = DateExt.UTC('5,January,2009');
        forwards[1] = 0.0025999342800;
        dates[2] = DateExt.UTC('29,January,2009');
        forwards[2] = 0.0053123275500;
        dates[3] = DateExt.UTC('27,February,2009');
        forwards[3] = 0.0197049598721;
        dates[4] = DateExt.UTC('30,March,2009');
        forwards[4] = 0.0220524845296;
        dates[5] = DateExt.UTC('29,June,2009');
        forwards[5] = 0.0217076395643;
        dates[6] = DateExt.UTC('29,December,2009');
        forwards[6] = 0.0230349627478;
        dates[7] = DateExt.UTC('29,December,2010');
        forwards[7] = 0.0087631647476;
        dates[8] = DateExt.UTC('29,December,2011');
        forwards[8] = 0.0219084299499;
        dates[9] = DateExt.UTC('31,December,2012');
        forwards[9] = 0.0244798766219;
        dates[10] = DateExt.UTC('30,December,2013');
        forwards[10] = 0.0267885498456;
        dates[11] = DateExt.UTC('29,December,2014');
        forwards[11] = 0.0266922867562;
        dates[12] = DateExt.UTC('29,December,2015');
        forwards[12] = 0.0271052126386;
        dates[13] = DateExt.UTC('29,December,2016');
        forwards[13] = 0.0268829891648;
        dates[14] = DateExt.UTC('29,December,2017');
        forwards[14] = 0.0264594744498;
        dates[15] = DateExt.UTC('31,December,2018');
        forwards[15] = 0.0273450367424;
        dates[16] = DateExt.UTC('30,December,2019');
        forwards[16] = 0.0294852614749;
        dates[17] = DateExt.UTC('29,December,2020');
        forwards[17] = 0.0285556119719;
        dates[18] = DateExt.UTC('29,December,2021');
        forwards[18] = 0.0305557764659;
        dates[19] = DateExt.UTC('29,December,2022');
        forwards[19] = 0.0292244738422;
        dates[20] = DateExt.UTC('29,December,2023');
        forwards[20] = 0.0263917004194;
        dates[21] = DateExt.UTC('29,December,2028');
        forwards[21] = 0.0239626970243;
        dates[22] = DateExt.UTC('29,December,2033');
        forwards[22] = 0.0216417108090;
        dates[23] = DateExt.UTC('29,December,2038');
        forwards[23] = 0.0228343838422;
        dates[24] = DateExt.UTC('31,December,2199');
        ...
        const issueDate = DateExt.UTC('23,July,2008');
        const maturityDate = DateExt.UTC('1,August,2013');
