import { constant, identity, InverseCumulativeNormal, InverseCumulativeRng, LinearRegression, MersenneTwisterUniformRng, SavedSettings, square } from 'https://cdn.jsdelivr.net/npm/@quantlib/ql@latest/ql.mjs';
